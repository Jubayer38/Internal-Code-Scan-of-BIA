...
{
    public class CorpSimTransferWithOtpBioReqModel
    {
        public CorpSimTransferWithOtpData data { get; set; } = new CorpSimTransferWithOtpData();
    }

    public class CorpSimTransferWithOtpData
    {
        public string type { get; set; } = string.Empty;
        public int id { get; set; }
        public CorpSimTransferWithOtpAttributes attributes { get; set; } = new CorpSimTransferWithOtpAttributes();
    }

    public class CorpSimTransferWithOtpAttributes
    {
