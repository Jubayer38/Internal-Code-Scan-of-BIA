...
{
    public class NewConnectionRequestValidator : Attribute, IAsyncActionFilter
    { 
        public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            var request = context.HttpContext.Request;
            var errors = new List<string>();
            NewConnectionRequestModel? model = null;
            ...
            if (isForm)
            {
                model = context.ActionArguments
                              .Values
                              .FirstOrDefault(v => v is NewConnectionRequestModel) as NewConnectionRequestModel;
            }
            else
            {
                ...
                try
                {
                    ...
                    model = JsonSerializer.Deserialize<NewConnectionRequestModel>(bodyStr, new JsonSerializerOptions
                    {
        ...
        private void ValidateModel(NewConnectionRequestModel model, List<string> errors)
        {
