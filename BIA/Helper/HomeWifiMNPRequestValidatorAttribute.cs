...
{
    public class HomeWifiMNPRequestValidatorAttribute : Attribute, IAsyncActionFilter
    { 
        public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            var request = context.HttpContext.Request;
            var errors = new List<string>();
            HomeWifiMNPSubmitRequestModel? model = null;
            ...
            if (isForm)
            {
                model = context.ActionArguments
                              .Values
                              .FirstOrDefault(v => v is HomeWifiMNPSubmitRequestModel) as HomeWifiMNPSubmitRequestModel;
            }
            else
            {
                ...
                try
                {
                    ...
                    model = JsonSerializer.Deserialize<HomeWifiMNPSubmitRequestModel>(bodyStr, new JsonSerializerOptions
                    {
        ...
        private void ValidateModel(HomeWifiMNPSubmitRequestModel model, List<string> errors)
        {
