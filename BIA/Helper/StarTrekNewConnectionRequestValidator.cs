...
{
    public class StarTrekNewConnectionRequestValidator : Attribute, IAsyncActionFilter
    {
        public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            var request = context.HttpContext.Request;
            var errors = new List<string>();
            StarTrekNewConnectionRequestModel? model = null;
            ...
            if (isForm)
            {
                model = context.ActionArguments.Values.OfType<StarTrekNewConnectionRequestModel>().FirstOrDefault();
                
                model = context.ActionArguments
                              .Values
                              .FirstOrDefault(v => v is StarTrekNewConnectionRequestModel) as StarTrekNewConnectionRequestModel;
            }
            else
            {
                ...
                try
                {
                    ...
                    model = JsonSerializer.Deserialize<StarTrekNewConnectionRequestModel>(bodyStr, new JsonSerializerOptions
                    {
        ...
        private void ValidateModel(StarTrekNewConnectionRequestModel model, List<string> errors)
        {
