...
{
    public class StarTrekSIMReplacementOrderRequestValidatorAttribute : Attribute, IAsyncActionFilter
    { 
        public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            var request = context.HttpContext.Request;
            var errors = new List<string>();
            StarTrekSimReplacementRequestModel? model = null;
            ...
            if (isForm)
            {
                model = context.ActionArguments
                              .Values
                              .FirstOrDefault(v => v is StarTrekSimReplacementRequestModel) as StarTrekSimReplacementRequestModel;
            }
            else
            {
                ...
                try
                {
                    ...
                    model = JsonSerializer.Deserialize<StarTrekSimReplacementRequestModel>(bodyStr, new JsonSerializerOptions
                    {
        ...
        private void ValidateModel(StarTrekSimReplacementRequestModel model, List<string> errors)
        {
