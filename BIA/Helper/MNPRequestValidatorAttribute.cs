...
{
    public class MNPRequestValidatorAttribute : Attribute, IAsyncActionFilter
    { 
        public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            var request = context.HttpContext.Request;
            var errors = new List<string>();
            MNPSubmitRequestModel? model = null;
            ...
            if (isForm)
            {
                model = context.ActionArguments
                              .Values
                              .FirstOrDefault(v => v is MNPSubmitRequestModel) as MNPSubmitRequestModel;
            }
            else
            {
                ...
                try
                {
                    ...
                    model = JsonSerializer.Deserialize<MNPSubmitRequestModel>(bodyStr, new JsonSerializerOptions
                    {
        ...
        private void ValidateModel(MNPSubmitRequestModel model, List<string> errors)
        {
