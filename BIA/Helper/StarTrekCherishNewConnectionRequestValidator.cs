...
{
    public class StarTrekCherishNewConnectionRequestValidator : Attribute, IAsyncActionFilter
    {
        public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            ...
            if (isForm)
            {
                model = context.ActionArguments.Values.OfType<CherishNewConnectionRequestModel>().FirstOrDefault();
